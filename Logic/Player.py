...
class Players:
	...
	brawl_pass_tokens = settings['BrawlPassTokens']
	free_pass_level = settings['FreePassLVL']
	brawl_pass_level = settings['BrawlPassLVL']
	brawl_pass_unlocked = settings['BrawlPassUnlocked'] 
	region = "RU"
	tokens = 0
	reward_trophy_road = 1
