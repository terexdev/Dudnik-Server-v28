...
class BattleLogMessage(Writer):
    ...
    def encode(self):
        ...
        self.writeVint(0)
        self.writeVint(2147483647)     # Timestamp
        self.writeVint(1)       # Unknown
        self.writeVint(2147483647)      # Trophies
        self.writeVint(2147483647)      # Time Survived
        self.writeUInt8(4)      # Type [0 = Power Play, 1 = Friendly, 2 = Championship
        # 3 = Friendly, 4 = Ranked]
        self.writeScId(15, 269) # Map SCID
